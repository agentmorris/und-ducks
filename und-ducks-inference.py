...
# Absolute paths
project_dir = os.path.expanduser('~/tmp/und-ducks')    
...
model_file = os.path.join(model_base,
                          'und-ducks-yolov5x6-nolinks-b8-img1280-e200-best.pt')

dataset_definition_file = os.path.expanduser('~/data/und-ducks/dataset.yaml')  
...
def run_model_on_folder(input_folder_base,recursive=True):
    """
    Run the detection model on all images in a folder
    """
